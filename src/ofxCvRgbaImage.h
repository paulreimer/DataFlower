...
public:
    ...
    ofxCvRgbaImage();
    ofxCvRgbaImage( const ofxCvRgbaImage& mom );
    ...
    virtual void  set( int valueR, int valueG, int valueB, int valueA=255);
    virtual void  operator -= ( float value );
    virtual void  operator += ( float value );
	
    virtual void  setFromPixels( unsigned char * _pixels, int w, int h );

	virtual void  setFromGrayscalePlanarImages(ofxCvGrayscaleImage& red,
    ...
    virtual void  setAlpha(ofxCvGrayscaleImage& alpha);
	
  	
    virtual void  operator = ( unsigned char* _pixels );
    virtual void  operator = ( const ofxCvRgbaImage& mom );
    ...
    virtual void  convertToGrayscalePlanarImages(ofxCvGrayscaleImage& red,
												 ofxCvGrayscaleImage& green,
												 ofxCvGrayscaleImage& blue);
...
private:
    ...
    IplImage*  cvColorImage;    // internal helper color, allocated on demand	
};
